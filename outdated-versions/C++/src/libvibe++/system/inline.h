 ...
 *
 * ViBe is covered by a patent (see http://www.telecom.uliege.be/research/vibe).
 *
 ...
 */
#ifndef _LIB_VIBE_XX_SYSTEM_INLINE_H_
#define _LIB_VIBE_XX_SYSTEM_INLINE_H_

#define STRONG_INLINE                                                          \
  __attribute__((always_inline))

#endif /* _LIB_VIBE_XX_SYSTEM_INLINE_H_ */
